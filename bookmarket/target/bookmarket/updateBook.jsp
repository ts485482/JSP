...
<div class="container py-4">
    ...
    <div class="row align-items-md-stretch">
        ...
        <div class="col-md-7">
            <form name="newBook" action="./porcessUpdateBook.jsp" method="post" enctype="multipart/form-data">
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    <input type="text" name="publisher" class="form-control" value="<%=rs.getString("b_id")%>">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                <div class="con-sm-offset-2 col-sm-10">
