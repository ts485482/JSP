    ...
    <div class="row align-items-md-stretch">
        <form name="newBook" action="processAddBook.jsp" method="post">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-3">
                    <input type="radio" name="condition" class="form-control"> 신규 도서
                    <input type="radio" name="condition" class="form-control"> 중고 도서
                    <input type="radio" name="condition" class="form-control"> E-Book
                </div>
            </div>
            <div class="mb-3 row">
                <div class="col-sm-offset-2 col-sm-10">
                    <input type="submit" href="addBook.jsp" class="btn btn-primary" value="등록">
                </div>
            </div>
        </form>
    </div>
