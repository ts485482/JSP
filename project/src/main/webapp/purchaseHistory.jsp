...
<div class="container py-4">
    ...
    <div class="container mt-5" style="min-height: 600px;">
        <h3 class="fw-bold mb-4">마이페이지 - 구매내역</h3>
        ...
        <ul class="nav nav-tabs mb-4">
            ...
            <li class="nav-item">
                <a class="nav-link active fw-bold text-dark" href="purchaseHistory.jsp">구매내역</a>
            </li>
            <li class="nav-item">
        ...
        %>
            <div class="text-center py-5 my-5 border rounded bg-light">
                <p class="text-muted mb-0 fs-5">배송이 완료된 상품이 존재하지 않습니다.</p>
                <a href="./orderStatus.jsp" class="btn btn-dark mt-3">주문현황 보러가기</a>
